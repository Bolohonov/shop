...
Payment Service API
- API version: 1.0.0
  - Build date: 2025-05-08T12:09:19.318782400+04:00[Europe/Astrakhan]
...
------------ | ------------- | ------------- | -------------
*PaymentApi* | [**getBalance**](docs/PaymentApi.md#getBalance) | **GET** /payment | Получить текущий баланс
*PaymentApi* | [**makePayment**](docs/PaymentApi.md#makePayment) | **POST** /payment | Провести платёж
